...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
			'class'=>'CLinkColumn',
			'label'=>'new goods',
			'urlExpression'=>'Yii::app()->createURL("admin/goods/create",array("cat_id"=>$data->primaryKey))',		
		),	
		array(
			'class'=>'CLinkColumn',
			'label'=>'view goods',
			'urlExpression'=>'Yii::app()->createURL("admin/goods/admin",array("cat_id"=>$data->primaryKey))',		
		),	
	),
)); ?>
